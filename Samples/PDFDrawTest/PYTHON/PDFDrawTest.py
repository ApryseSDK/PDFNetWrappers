...
def main():
    ...
    print("Example 1: " + output_path + "tiger_92dpi.png. Done.")
    ...
    itr = doc.GetPageIterator()
    while itr.HasNext():
        filename = output_path + "newsletter" + str(itr.Current().GetIndex()) + ".jpg"
        print(filename)
    ...
    print("Example 3: " + output_path + "tiger_100dpi_rot90.raw. Done.")
    ...
    print("Example 4: " + output_path +"tiger_1000x1000.png. Done.")
    ...
    print("Example 4: " + output_path + "tiger_200x400_rot180.png. Done.")
    ...
    print("Example 4: " + output_path + "tiger_400x200_stretch.jpg. Done.")
    ...
    print("Example 7: Result saved in " + output_path + "out1.tif")
