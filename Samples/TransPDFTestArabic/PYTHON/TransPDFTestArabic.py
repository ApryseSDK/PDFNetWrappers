...
def main():
    ...
    try:
        ...
        doc = PDFDoc(input_path + "translation-test.pdf")
        ...
        TransPDF.ExtractXLIFF(doc, output_path + "translation-test.xlf", options)

        # Save the fielded PDF
        doc.Save(output_path + "translation-test-fielded.pdf", SDFDoc.e_linearized)
