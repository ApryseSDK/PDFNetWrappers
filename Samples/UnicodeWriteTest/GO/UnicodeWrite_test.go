...
func ReadUnicodeTextLinesFromFile(  writer ElementWriter, 
                                    ...
                                    lineSpace float64, 
                                    showNumOfLines bool, 
                                    readLines bool, inputPath string){
...
func TestUnicodeWrite(t *testing.T){
    ...
    ReadUnicodeTextLinesFromFile(writer, indexedFont, eb, linePos, lineSpace, true, false, inputPath)
    ReadUnicodeTextLinesFromFile(writer, indexedFont, eb, linePos, lineSpace, false, true, inputPath)
