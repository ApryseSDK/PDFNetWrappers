...
if($LicenseKey == "YOUR_PDFTRON_LICENSE_KEY"){
    throw new Exception("Please enter your license key by replacing \"YOUR_PDFTRON_LICENSE_KEY\" that is assigned to the LicenseKey variable in Samples/LicenseKey/PHP/LicenseKey.php. If you do not have a license key, please go to https://www.pdftron.com/pws/get-key to obtain a demo license or https://www.pdftron.com/form/contact-sales to obtain a production key.");
}
?>
